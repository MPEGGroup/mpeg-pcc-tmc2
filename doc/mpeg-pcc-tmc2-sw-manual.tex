...
\title{V-PCC test model v5 user manual}
\author{%
	Julien Ricard
	\email{julien.ricard@technicolor.com}
}

\mpegmeeting{January 2019, Marrakech, Morocco}
\mpegdocnum{w18176}
\mpegdocstatus{Draft}
\mpegdocsource{3DG}
...
for the V-PCC project. It applies to version 5.0 of the software.
\end{abstract}
