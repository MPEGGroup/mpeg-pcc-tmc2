...
IF( NOT EXISTS "${HM_DIR}/README" )
  MESSAGE("HM clone: ${HM_DIR}")
  EXECUTE_PROCESS( COMMAND git svn clone https://hevc.hhi.fraunhofer.de/svn/svn_HEVCSoftware/tags/${HM_VERSION}/ ${HM_DIR} RESULT_VARIABLE ret)
  IF( NOT ${ret} EQUAL "0")
    MESSAGE( FATAL_ERROR "Error during the HM git svn clone process. Check that git-svn is well installed on your system.")
  ENDIF()
ELSE()
  MESSAGE("HM already cloned: ${HM_DIR}")
ENDIF()

IF( NOT EXISTS "${HM_DIR}/PATCHED" )
  MESSAGE("HM patch: ${HM_DIR}")
  SET( HM_PATCH ${CMAKE_SOURCE_DIR}/dependencies/hm-modification/pcc_me-ext_and_namespace_for_HM-16.20+SCM-8.8.patch )
  EXECUTE_PROCESS( COMMAND git apply ${HM_PATCH} WORKING_DIRECTORY ${HM_DIR} RESULT_VARIABLE ret )
  IF( NOT ${ret} EQUAL "0")
...
ELSE()
  MESSAGE("HM already patched: ${HM_DIR}")
ENDIF()
