...
IF( NOT EXISTS "${HM_DIR}/README" )
  ...
  ENDIF()
  EXECUTE_PROCESS( COMMAND svn patch ${CMAKE_SOURCE_DIR}/dependencies/hm-modification/pcc_me-ext_for_HM-16.20+SCM-8.8.patch WORKING_DIRECTORY ${HM_DIR}  RESULT_VARIABLE ret)
  IF( NOT ${ret} EQUAL "0")
