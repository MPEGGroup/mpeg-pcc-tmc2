...
IF( NOT EXISTS "${HM_DIR}/README" )
  ...
  EXECUTE_PROCESS( COMMAND git clone https://vcgit.hhi.fraunhofer.de/jvet/HM.git ${HM_DIR} RESULT_VARIABLE ret)
  IF( NOT ${ret} EQUAL "0")
    MESSAGE( FATAL_ERROR "Error during the HM git clone process. Check that git is well installed on your system.")
  ENDIF()  
  EXECUTE_PROCESS( COMMAND git checkout ${HM_VERSION} WORKING_DIRECTORY ${HM_DIR} RESULT_VARIABLE ret)   
ELSE()
