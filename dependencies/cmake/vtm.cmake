...
IF( NOT EXISTS "${VTM_DIR}/CMakeLists.txt" )
  MESSAGE("VTM clone: ${VTM_LIB_SOURCE_DIR}")
   EXECUTE_PROCESS( COMMAND git clone --branch ${VTM_VERSION} https://vcgit.hhi.fraunhofer.de/jvet/VVCSoftware_VTM.git/ ${VTM_DIR} RESULT_VARIABLE ret)
   EXECUTE_PROCESS( COMMAND git apply ${CMAKE_SOURCE_DIR}/dependencies/vtm-modification/adaptions_for_vtm_11_2.patch WORKING_DIRECTORY ${VTM_DIR}  RESULT_VARIABLE ret)
ELSE()
